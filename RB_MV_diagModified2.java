...
public class RB_MV_diagModified2{
...
// Method 4: A'x in JSA  444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444   
 ...
 public static double AxinDiag( double[] val, int[] diag, double[] x, int n, int U, int L ) { 
...
public static double ATxinDiag( double[] val, int[] diag, double[] x, int n, int U, int L ) { 
 double [] y5= new double[n];
   int j,i;
    double startTime5 = System.currentTimeMillis();
     // A's main and super_diagonals elements multiply with vector x
...
//Main function **************************************************************************8	
 // public static void main(String[] args){
   ...
   public static void main(String[] args) throws Throwable {
     PrintStream out = new PrintStream(new FileOutputStream("RB_MV1.xlsx"));
     System.setOut(out);

    System.out.println("n" + "," + "bandwidth"+ "," + "%of nnz" + "," + "Ax_CRS" + ","+ "Ax_JSA" +","+ "Ax_Diag"+ "," +"A'x_CRS" +","+ "A'x_JSA"+ ","+"A'x_Diag"); 
    //50000 is upper bound              
  // for ( int n = 10; n <=143000; n+=1000) {
...
for ( int n =125000; n <=126000; n+=1000) {
      int t=(2*n-1)/1200;
  ...
  double[][] val_JSA=(double[][]) CRSObjects[3];
   ...
   //Time of Ax in CRS, JSA, Diag
      ...
      double t1_Diag= AxinDiag( val_Diag, diag, x, n, U, L);
   ...
   //time of A'x in CRS, JSA, Diag
     double t2_CRS=ATxinCRS(val_CRS, colind_CRS, rowptr_CRS, x, n );
      ...
      double t2_Diag= ATxinDiag( val_Diag, diag, x, n, U, L);
