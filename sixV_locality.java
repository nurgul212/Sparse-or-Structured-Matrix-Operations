...
public static void main(String[] args) throws Throwable {
  PrintStream out = new PrintStream(new FileOutputStream("sixV_locality1.xls"));
  System.setOut(out);
  System.out.println("N" +"," + "V1_ijk"  + "," +"V2_jik"  + "," +"V3_jki" + ","+"V4_kji" + "," +"V5_kij"  + ","+ "V6_ikj"  + ","+
                     "N" +"," + "V1_ijk2D" + "," +"V2_jik2D"  + "," +"V3_jki2D" + ","+"V4_kji2D" + "," +"V5_kij2D"  + ","+ "V6_ikj2D") ;       
...
System.out.println(n +"," + t1_ijk1  + ","+t2_jik1 + "," +t3_jki1 + "," +t4_kji1  + "," + t5_kij1 + "," + t6_ikj1 + "," + 
